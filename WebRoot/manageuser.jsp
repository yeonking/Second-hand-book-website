	         ...
	         <% if(session.getAttribute("userbean_s")==null){%>
				 ...
				 <%  List list=operat.getalluser(); 
				  ...
				  <ul class="cart-header">
				    ...
				    <li><%=userbean.getDbSex() %></li>
				    <li><%=userbean.getDbBirth() %></li>
				    <li><%=userbean.getDbAdd() %></li>			    
				    <li><%=userbean.getDbTel() %></li>
				    <li><%=userbean.getDbEmail() %></li>
				    <form action="./DoDeleteUserServlet" method="post">
				    	<input type="hidden" name="memid" value="<%=userbean.getDbMemberID() %>" />
				    	<li><div class="container"><div class="account_grid"><div class=" login-right">
